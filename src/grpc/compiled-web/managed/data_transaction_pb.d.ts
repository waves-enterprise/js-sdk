...
export class DataTransaction extends jspb.Message {
  ...
  getDataList(): data_entry_pb.DataEntry[]
  setDataList(value: data_entry_pb.DataEntry[]): DataTransaction
  ...
  setProofsList(value: (Uint8Array | string)[]): DataTransaction
...
export namespace DataTransaction {
  export type AsObject = {
    ...
    dataList: data_entry_pb.DataEntry.AsObject[],
    timestamp: number,
    fee: number,
