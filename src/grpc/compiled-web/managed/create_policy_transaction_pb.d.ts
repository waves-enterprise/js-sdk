...
export class CreatePolicyTransaction extends jspb.Message {
  ...
  setRecipientsList(value: Array<Uint8Array | string>): CreatePolicyTransaction;
  ...
  setOwnersList(value: Array<Uint8Array | string>): CreatePolicyTransaction;
  ...
  setProofsList(value: Array<Uint8Array | string>): CreatePolicyTransaction;
