...
export class UpdatePolicyTransaction extends jspb.Message {
  ...
  setRecipientsList(value: (Uint8Array | string)[]): UpdatePolicyTransaction
  ...
  setOwnersList(value: (Uint8Array | string)[]): UpdatePolicyTransaction
  ...
  setProofsList(value: (Uint8Array | string)[]): UpdatePolicyTransaction
