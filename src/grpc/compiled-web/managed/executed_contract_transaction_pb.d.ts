...
export class ExecutedContractTransaction extends jspb.Message {
  ...
  setResultsList(value: Array<data_entry_pb.DataEntry>): ExecutedContractTransaction;
  ...
  getValidationProofsList(): Array<validation_proof_pb.ValidationProof>;
  setValidationProofsList(value: Array<validation_proof_pb.ValidationProof>): ExecutedContractTransaction;
  ...
  setProofsList(value: Array<Uint8Array | string>): ExecutedContractTransaction;
...
export namespace ExecutedContractTransaction {
  export type AsObject = {
    ...
    validationProofsList: Array<validation_proof_pb.ValidationProof.AsObject>,
    timestamp: number,
