...
export class AtomicTransaction extends jspb.Message {
  ...
  setTransactionsList(value: managed_atomic_inner_transaction_pb.AtomicInnerTransaction[]): AtomicTransaction
  ...
  setProofsList(value: (Uint8Array | string)[]): AtomicTransaction
