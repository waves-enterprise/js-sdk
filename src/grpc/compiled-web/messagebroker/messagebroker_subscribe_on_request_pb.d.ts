...
export class SubscribeOnRequest extends jspb.Message {
  ...
  setEventsFiltersList(value: Array<EventsFilter>): SubscribeOnRequest;
...
export class TxTypeFilter extends jspb.Message {
  ...
  setTxTypesList(value: Array<number>): TxTypeFilter;
...
export class ContractIdFilter extends jspb.Message {
  ...
  setContractIdsList(value: Array<Uint8Array | string>): ContractIdFilter;
