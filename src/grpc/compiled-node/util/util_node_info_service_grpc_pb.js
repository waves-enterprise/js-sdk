...
var util_util_node_info_service_pb = require('../util/util_node_info_service_pb.js');
...
function serialize_wavesenterprise_NodeConfigResponse(arg) {
  if (!(arg instanceof util_util_node_info_service_pb.NodeConfigResponse)) {
...
function deserialize_wavesenterprise_NodeConfigResponse(buffer_arg) {
  return util_util_node_info_service_pb.NodeConfigResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var NodeInfoServiceService = exports.NodeInfoServiceService = {
  nodeConfig: {
    ...
    responseType: util_util_node_info_service_pb.NodeConfigResponse,
