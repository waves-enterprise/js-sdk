...
var util_util_contract_status_service_pb = require('../util/util_contract_status_service_pb.js');
var google_protobuf_wrappers_pb = require('google-protobuf/google/protobuf/wrappers_pb.js');

function serialize_wavesenterprise_ContractExecutionRequest(arg) {
  if (!(arg instanceof util_util_contract_status_service_pb.ContractExecutionRequest)) {
...
function deserialize_wavesenterprise_ContractExecutionRequest(buffer_arg) {
  return util_util_contract_status_service_pb.ContractExecutionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_ContractExecutionResponse(arg) {
  if (!(arg instanceof util_util_contract_status_service_pb.ContractExecutionResponse)) {
...
function deserialize_wavesenterprise_ContractExecutionResponse(buffer_arg) {
  return util_util_contract_status_service_pb.ContractExecutionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ContractStatusServiceService = exports.ContractStatusServiceService = {
  contractExecutionStatuses: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: util_util_contract_status_service_pb.ContractExecutionRequest,
    responseType: util_util_contract_status_service_pb.ContractExecutionResponse,
