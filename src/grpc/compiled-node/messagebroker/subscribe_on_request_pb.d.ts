...
export class SubscribeOnRequest extends jspb.Message {
  ...
  setEventsFiltersList(value: EventsFilter[]): void
...
export class TxTypeFilter extends jspb.Message {
  ...
  setTxTypesList(value: number[]): void
...
export class ContractIdFilter extends jspb.Message {
  ...
  getContractIdsList_asU8(): Uint8Array[]
  getContractIdsList_asB64(): string[]
  setContractIdsList(value: (Uint8Array | string)[]): void
