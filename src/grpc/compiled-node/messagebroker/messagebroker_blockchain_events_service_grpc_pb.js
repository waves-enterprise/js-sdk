...
var messagebroker_messagebroker_blockchain_event_pb = require('../messagebroker/messagebroker_blockchain_event_pb.js');
var messagebroker_messagebroker_subscribe_on_request_pb = require('../messagebroker/messagebroker_subscribe_on_request_pb.js');

function serialize_wavesenterprise_BlockchainEvent(arg) {
  if (!(arg instanceof messagebroker_messagebroker_blockchain_event_pb.BlockchainEvent)) {
...
function deserialize_wavesenterprise_BlockchainEvent(buffer_arg) {
  return messagebroker_messagebroker_blockchain_event_pb.BlockchainEvent.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_SubscribeOnRequest(arg) {
  if (!(arg instanceof messagebroker_messagebroker_subscribe_on_request_pb.SubscribeOnRequest)) {
...
function deserialize_wavesenterprise_SubscribeOnRequest(buffer_arg) {
  return messagebroker_messagebroker_subscribe_on_request_pb.SubscribeOnRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BlockchainEventsServiceService = exports.BlockchainEventsServiceService = {
  subscribeOn: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: messagebroker_messagebroker_subscribe_on_request_pb.SubscribeOnRequest,
    responseType: messagebroker_messagebroker_blockchain_event_pb.BlockchainEvent,
