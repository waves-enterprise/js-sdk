...
export class MicroBlockAppended extends jspb.Message {
  ...
  setTxsList(value: managed_transaction_pb.Transaction[]): void
...
export class BlockAppended extends jspb.Message {
  ...
  getTxIdsList_asU8(): Uint8Array[]
  getTxIdsList_asB64(): string[]
  setTxIdsList(value: (Uint8Array | string)[]): void
  ...
  setFeaturesList(value: number[]): void
...
export class RollbackCompleted extends jspb.Message {
  ...
  getRollbackTxIdsList_asU8(): Uint8Array[]
  getRollbackTxIdsList_asB64(): string[]
  setRollbackTxIdsList(value: (Uint8Array | string)[]): void
