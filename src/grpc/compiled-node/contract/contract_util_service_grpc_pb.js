...
var contract_contract_util_service_pb = require('../contract/contract_util_service_pb.js');
...
function serialize_wavesenterprise_NodeTimeResponse(arg) {
  if (!(arg instanceof contract_contract_util_service_pb.NodeTimeResponse)) {
...
function deserialize_wavesenterprise_NodeTimeResponse(buffer_arg) {
  return contract_contract_util_service_pb.NodeTimeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var UtilServiceService = exports.UtilServiceService = {
  getNodeTime: {
    ...
    responseType: contract_contract_util_service_pb.NodeTimeResponse,
