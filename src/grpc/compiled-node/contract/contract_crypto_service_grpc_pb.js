...
var contract_contract_crypto_service_pb = require('../contract/contract_crypto_service_pb.js');
var google_protobuf_wrappers_pb = require('google-protobuf/google/protobuf/wrappers_pb.js');
var constants_pb = require('../constants_pb.js');

function serialize_wavesenterprise_DecryptDataRequest(arg) {
  if (!(arg instanceof contract_contract_crypto_service_pb.DecryptDataRequest)) {
...
function deserialize_wavesenterprise_DecryptDataRequest(buffer_arg) {
  return contract_contract_crypto_service_pb.DecryptDataRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_DecryptDataResponse(arg) {
  if (!(arg instanceof contract_contract_crypto_service_pb.DecryptDataResponse)) {
...
function deserialize_wavesenterprise_DecryptDataResponse(buffer_arg) {
  return contract_contract_crypto_service_pb.DecryptDataResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_EncryptDataRequest(arg) {
  if (!(arg instanceof contract_contract_crypto_service_pb.EncryptDataRequest)) {
...
function deserialize_wavesenterprise_EncryptDataRequest(buffer_arg) {
  return contract_contract_crypto_service_pb.EncryptDataRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_EncryptSeparateResponse(arg) {
  if (!(arg instanceof contract_contract_crypto_service_pb.EncryptSeparateResponse)) {
...
function deserialize_wavesenterprise_EncryptSeparateResponse(buffer_arg) {
  return contract_contract_crypto_service_pb.EncryptSeparateResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_EncryptedForManyResponse(arg) {
  if (!(arg instanceof contract_contract_crypto_service_pb.EncryptedForManyResponse)) {
...
function deserialize_wavesenterprise_EncryptedForManyResponse(buffer_arg) {
  return contract_contract_crypto_service_pb.EncryptedForManyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var CryptoServiceService = exports.CryptoServiceService = {
  encryptSeparate: {
    ...
    requestType: contract_contract_crypto_service_pb.EncryptDataRequest,
    responseType: contract_contract_crypto_service_pb.EncryptSeparateResponse,
  ...
  encryptCommon: {
    ...
    responseStream: false,
    requestType: contract_contract_crypto_service_pb.EncryptDataRequest,
    responseType: contract_contract_crypto_service_pb.EncryptedForManyResponse,
    requestSerialize: serialize_wavesenterprise_EncryptDataRequest,
    requestDeserialize: deserialize_wavesenterprise_EncryptDataRequest,
  ...
  decrypt: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: contract_contract_crypto_service_pb.DecryptDataRequest,
    responseType: contract_contract_crypto_service_pb.DecryptDataResponse,
