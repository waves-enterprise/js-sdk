...
var contract_contract_pki_service_pb = require('../contract/contract_pki_service_pb.js');
var google_protobuf_wrappers_pb = require('google-protobuf/google/protobuf/wrappers_pb.js');

function serialize_wavesenterprise_PkiSignRequest(arg) {
  if (!(arg instanceof contract_contract_pki_service_pb.PkiSignRequest)) {
...
function deserialize_wavesenterprise_PkiSignRequest(buffer_arg) {
  return contract_contract_pki_service_pb.PkiSignRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_PkiSignResponse(arg) {
  if (!(arg instanceof contract_contract_pki_service_pb.PkiSignResponse)) {
...
function deserialize_wavesenterprise_PkiSignResponse(buffer_arg) {
  return contract_contract_pki_service_pb.PkiSignResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_PkiVerifyRequest(arg) {
  if (!(arg instanceof contract_contract_pki_service_pb.PkiVerifyRequest)) {
...
function deserialize_wavesenterprise_PkiVerifyRequest(buffer_arg) {
  return contract_contract_pki_service_pb.PkiVerifyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_PkiVerifyResponse(arg) {
  if (!(arg instanceof contract_contract_pki_service_pb.PkiVerifyResponse)) {
...
function deserialize_wavesenterprise_PkiVerifyResponse(buffer_arg) {
  return contract_contract_pki_service_pb.PkiVerifyResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var PkiServiceService = exports.PkiServiceService = {
  sign: {
    ...
    requestType: contract_contract_pki_service_pb.PkiSignRequest,
    responseType: contract_contract_pki_service_pb.PkiSignResponse,
  ...
  verify: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: contract_contract_pki_service_pb.PkiVerifyRequest,
    responseType: contract_contract_pki_service_pb.PkiVerifyResponse,
