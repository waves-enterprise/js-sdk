...
var contract_contract_permission_service_pb = require('../contract/contract_permission_service_pb.js');
var google_protobuf_wrappers_pb = require('google-protobuf/google/protobuf/wrappers_pb.js');

function serialize_wavesenterprise_AddressesPermissionsRequest(arg) {
  if (!(arg instanceof contract_contract_permission_service_pb.AddressesPermissionsRequest)) {
...
function deserialize_wavesenterprise_AddressesPermissionsRequest(buffer_arg) {
  return contract_contract_permission_service_pb.AddressesPermissionsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_AddressesPermissionsResponse(arg) {
  if (!(arg instanceof contract_contract_permission_service_pb.AddressesPermissionsResponse)) {
...
function deserialize_wavesenterprise_AddressesPermissionsResponse(buffer_arg) {
  return contract_contract_permission_service_pb.AddressesPermissionsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_PermissionsRequest(arg) {
  if (!(arg instanceof contract_contract_permission_service_pb.PermissionsRequest)) {
...
function deserialize_wavesenterprise_PermissionsRequest(buffer_arg) {
  return contract_contract_permission_service_pb.PermissionsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_wavesenterprise_PermissionsResponse(arg) {
  if (!(arg instanceof contract_contract_permission_service_pb.PermissionsResponse)) {
...
function deserialize_wavesenterprise_PermissionsResponse(buffer_arg) {
  return contract_contract_permission_service_pb.PermissionsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var PermissionServiceService = exports.PermissionServiceService = {
  getPermissions: {
    ...
    requestType: contract_contract_permission_service_pb.PermissionsRequest,
    responseType: contract_contract_permission_service_pb.PermissionsResponse,
  ...
  getPermissionsForAddresses: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: contract_contract_permission_service_pb.AddressesPermissionsRequest,
    responseType: contract_contract_permission_service_pb.AddressesPermissionsResponse,
