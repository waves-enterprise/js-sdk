import { DEFAULT_MAINNET_CONFIG } from "../src/constants";
import { create, IWavesAPI } from "../src/WavesAPI";
import { libs, utils } from "@vostokplatform/signature-generator";

let Waves: IWavesAPI;

const wavesConfig: any = {
  ...DEFAULT_MAINNET_CONFIG,
  nodeAddress: 'https://nixon.vostokservices.com/node-1',
...
describe('', () => {
  beforeEach(() => {
    Waves = create({ initialConfiguration: wavesConfig });
  });

  it('', () => {
    console.log(
      Waves.crypto.isValidSignature(
